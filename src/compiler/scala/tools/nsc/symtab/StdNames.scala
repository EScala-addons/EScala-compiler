...
trait StdNames extends reflect.generic.StdNames with NameManglers {
  ...
  trait CompilerTypeNames extends CompilerCommonNames {
    ...
    // @ESCALA
    final val Event: NameType        = "Event"
    // @ESCALA END
  ...
  trait CompilerTermNames extends CompilerCommonNames {    
    ...
    // @ESCALA
    final val OBSERVABLEkw: NameType = "observable"
    final val EVENTkw: NameType      = "evt"
    final val BEFOREkw: NameType     = "beforeExec"
    final val AFTERkw: NameType      = "afterExec"
    final val EXECUTIONkw: NameType  = "execution"
    final val IMPERATIVEkw: NameType = "imperative"
    // @ESCALA END
